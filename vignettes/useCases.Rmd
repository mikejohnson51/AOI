...
nwm::downloadNWM(AOI, files, param = 'accet')


GotrasterVis::levelplot(AOI$accet, 
...
```{r}
AOI = getAOI(list("Boulder", 10, 10)) %>% FedData::get_ssurgo(label = "test")
...
AOI = getAOI(list(office$lat, office$lon, 2, 2)) %>% bbox_st()
