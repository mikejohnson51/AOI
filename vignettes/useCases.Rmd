...
AOI was not developed not for its internal use but rather to integrates and easy the use of the many great spatial packages avialable in the R ecosystem. A few case studies will be demonstrated to provide a sense of how clear, intuitive AOI calls can make the use of many other packages easier. It should be emphasised these represent only a small number of the available geographic data packages and services available:
