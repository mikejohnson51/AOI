...
For example, I am a big fan of the restraunt "Rasta Pasta" in downtown Colorado Springs, but finding the spatial information regarding this location (such as lat/lon, address, city, ect) can be difficult. For this the revGeo function can be handy.

```{r, message = FALSE}
pt = revGeo("Rasta Pasta, Colorado Springs")
print(pt)
