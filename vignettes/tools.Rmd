...
For example, I am a big fan of the restaurant "Rasta Pasta" in downtown Colorado Springs, but finding the spatial information regarding this location (such as lat/lon, address, city, ect) can be difficult. For this the revGeo function can be handy.
...
Now that you are a AOI extraordinaire, be sure to check out some use cases on [use cases](./articles/usseCases.html) page. 
