...
Three main parameters are used to define all queries:  *state*, *county*, and *clip*. This page illustrates how the state and county parameters can be used define  a query, while the [Clip Areas](./articles/clipAreas.html) page describes the clip parameters.
